...
Celda::Celda(int coordenadaX, int coordenadaY, bool estadoMina) //Se envian los parametros hacia el constructor hacia la función recibiendo coordenadas x,y y el boolean
{
    this->coordenadaX = coordenadaX;    //Puntero this para señalar que la coordenada x equivale a la coordenada x, es decir guarda el contenido en memoria de coordenada x dentro de la coordenada
